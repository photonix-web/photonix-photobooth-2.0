    ...
    <Layout>
      ...
      >
        <img
          src={heroImage}
          alt=""
          className="absolute left-1/2 -translate-x-1/2 bottom-0 w-auto h-[55%] sm:h-[60%] md:translate-x-0 md:left-auto md:right-[-25px] md:h-[120%] md:bottom-[-25px] object-contain object-bottom md:object-center"
        />
